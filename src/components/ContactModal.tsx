      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-lg rounded-2xl border border-border/50 p-6 shadow-2xl"
            style={{
              background:
                "linear-gradient(145deg, hsl(220 20% 8% / 0.95), hsl(220 20% 6% / 0.98))",
              backdropFilter: "blur(24px)",
              boxShadow:
                "0 0 40px -10px hsl(199 89% 48% / 0.15), 0 25px 50px -12px rgba(0,0,0,0.5)",
            }}
          >
            {/* Close button */}
            <button
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs text-muted-foreground mb-1.5">
                          姓名/称谓 <span className="text-red-500">*</span>
                        </label>
                        <input
                      ...
                      <div>
                        <label className="block text-xs text-muted-foreground mb-1.5">
                          联系电话/微信 <span className="text-red-500">*</span>
                        </label>
                        <input
