  ...
  "risks": [
    {
      ...
      "title": "风险点简述（可以在这里写分析和理由）",
      "excerpt": "【必须是原文的逐字复制，一个字都不能改】",
      "suggestion": "【只写修改后的完整条款原文，不要包含任何分析、解释、理由、点评。这个字段的内容会直接替换原文，所以必须是可以直接放进合同里的正式条款文本】"
    }
  ],
...
- 绝对不要在 suggestion 中解释为什么要这样改
- 如果你想说明修改理由，请写在 title 字段中
